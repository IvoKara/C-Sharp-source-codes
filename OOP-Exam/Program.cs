    ...
    class Program
    {
        ...
        private static void CreateProduct(string[] args)
        {
            try
            {
                ...
                if(product.Type != product.Type.ToUpper())
                {
       ...
       private static void CreateVendingMachine(string[] args)
        {
            ...
            if (args.Length == 1)
            {
                try
                {
                    ...
                    if(vendingMachine.Id != vendingMachine.Id.ToLower() || vendingMachine.Id.Length <= 3)
                    {
        ...
        private static void SellProduct(string[] args)
        {
            try
            {
                if (machines[args[0]].Battery < products[args[1]].Price * 0.8 + 2)
                {
